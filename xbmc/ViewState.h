...
#if defined(HAS_SKIN_TOUCHED) && defined(TARGET_ANDROID)
#define DEFAULT_VIEW_LIST (VIEW_TYPE_WIDE << 16)
#define DEFAULT_VIEW_ICONS (VIEW_TYPE_WIDE << 16)
#define DEFAULT_VIEW_BIG_ICONS (VIEW_TYPE_WIDE << 16)
#define DEFAULT_VIEW_INFO (VIEW_TYPE_WIDE << 16)
#define DEFAULT_VIEW_BIG_INFO (VIEW_TYPE_BIG_WIDE << 16)
#else// XXX:
